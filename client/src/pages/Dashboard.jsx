...
export default function Dashboard() {
  ...
  return (
    <div className="app">
      ...
      <footer style={{textAlign:'center',padding:'2rem',color:'#9ca3af',fontSize:'0.85rem'}}>
        Built with love by Riya Aggarwal
        {' | '}
        <a href="https://linkedin.com/in/your-linkedin-id" target="_blank" rel="noreferrer" style={{color:'#4f46e5'}}>
          LinkedIn
        </a>
      </footer>
    </div>
